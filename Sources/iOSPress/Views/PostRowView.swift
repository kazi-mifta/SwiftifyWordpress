...
struct PostRowView: View {
    ...
    var body: some View {
        ...
        }.onTapGesture { // If the Post is dummy Loading Post Safari View won't Appear
            presentingSafariView = postTitle == "Loading Posts..." ? false : true
        }
...
// Initialize the Post Row with a Post structure
